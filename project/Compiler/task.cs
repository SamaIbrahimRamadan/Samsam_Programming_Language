...
namespace com.calitha.goldparser
{
    ...
    public class MyParser
    {
        ...
        {
            string message = "Parse error caused by token:  "+args.UnexpectedToken.ToString()+" In Line: "+args.UnexpectedToken.Location.LineNr+" ExpectedToken: "+args.ExpectedTokens.ToString();
